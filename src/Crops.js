...
function Crops() {
    ...
    return (
        <div className='container'>
                ...
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title" id="exampleModalLabel">Crop Information</h5>
                        ...
                        <div className="modal-body row">
                            <div className="col-sm-6">
                                <img className="img-fluid h-100 w-100" src={cropImageUrl[crop]} alt={crop} />
                            </div>
                            <div className="col-sm-6">
                                <img className="img-fluid h-100 w-100" src={fruitImageUrl[crop]} alt={crop} />
                            </div>
                        </div>
                        <div className="modal-body">
            ...
            <div className="row">
                {
                    Object.entries(cropImageUrl).map(([cropName, cropImage]) => {
                        return <div className="card col-md-3 m-3" style={{ width: "18rem", backgroundColor: 'hsl(81, 100%, 95%)' }}>
                            <img src={cropImage} className="h-60 w-60" alt="..." />
                            <div className="card-body float-bottom">
                                <h5 className="card-title">{cropName}</h5>
                                <a href="#" className="btn btn-success" onClick={() => displayModal(cropName)}>More information</a>
                            </div>
                        </div>
                    })
                }
